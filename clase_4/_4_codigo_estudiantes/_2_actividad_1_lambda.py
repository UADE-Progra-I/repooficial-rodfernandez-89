...
"""
lambdaCuadrado = lambda num1: num1**2

print(f"El cuadrado del numero 2 es {lambdaCuadrado(2)}")
print(f"El cuadrado del numero 5 es {lambdaCuadrado(5)}")
print(f"El cuadrado del numero 10 es {lambdaCuadrado(10)}")
...
"""
lambdaMayor = lambda num1, num2: num1 if num1 > num2 else num2

print(f"El mayor es el número {lambdaMayor (7, 3)}")
print(f"El mayor es el número {lambdaMayor (10, 15)}")
print(f"El mayor es el número {lambdaMayor (20, 20)}")
